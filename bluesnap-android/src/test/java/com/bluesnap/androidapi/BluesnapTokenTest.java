...
import static com.bluesnap.androidapi.MockJwtGenerator.generateMockJwt;
...
public class BluesnapTokenTest extends TestCase {
    ...
    public void notProductionTokenTest() {
        ...
        BluesnapToken token2 = new BluesnapToken(generateMockJwt(true), null);
    ...
    public void isProductionTokenTest() {
        BluesnapToken token1 = new BluesnapToken(generateMockJwt(false), null);
        assertTrue("is a production token", token1.isProduction());
        assertFalse("toString failed", TextUtils.isEmpty(token1.toString()));

        BluesnapToken token2 = new BluesnapToken(generateMockJwt(false), null);
