...
//        final String CARD_NUMBER_VALID_LUHN_UNKNOWN_TYPE = "1234123412341238";
    ...
    @Test
    public void test_end_to_end_credit_ach_ecp_checkout_flow() throws InterruptedException {
        final String paymentMethod = "ECP";

        final String routingNumber = "998877665";
        final String accountNumber = "223344556";
        final String accountType = "CONSUMER_CHECKING";
        final Double amount = 55.0;
        final String currencyNameCode = "USD";
        IntegrationTestsHelper.endToEndAchPaymentFlow(amount , currencyNameCode,paymentMethod, routingNumber, accountNumber, accountType);
