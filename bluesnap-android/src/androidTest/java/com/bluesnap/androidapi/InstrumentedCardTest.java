...
public class InstrumentedCardTest extends BSAndroidIntegrationTestsBase {
    ...
    public void testValidAmex() {
        ...
        for (String num : validAmex) {
            card.setNumber(num);
            assertTrue("AMEX luhn invalid", BlueSnapValidator.Companion.getInstance().creditCardNumberValidation(num));
            String type = creditCardTypeResolver.getType(card.getNumber());
            assertTrue("AMEX type mismatch: " + type + " " + num, CreditCardTypeResolver.AMEX.equals(type));
        }
    }
    ...
    public void tesValidMC() {
        ...
        for (String num : validMC) {
            card.setNumber(num);
            assertTrue("MASTERCARD luhn invalid: " + num, BlueSnapValidator.Companion.getInstance().creditCardNumberValidation(num));
            String type = creditCardTypeResolver.getType(card.getNumber());
            assertTrue("MASTERCARD type mismatch: " + type + " " + num, CreditCardTypeResolver.MASTERCARD.equals(type));
        }
    }
    ...
    public void testInValidMC() {
        ...
        for (String num : validMC) {
            card.setNumber(num);
            assertFalse("MASTERCARD luhn invalid: " + num, BlueSnapValidator.Companion.getInstance().creditCardNumberValidation(num));
            String type = creditCardTypeResolver.getType(card.getNumber());
            assertTrue("MASTERCARD type mismatch: " + type + " " + num, CreditCardTypeResolver.MASTERCARD.equals(type));
        }
    }
    ...
    public void testValidVisa() {
        ...
        for (String num : validMC) {
            card.setNumber(num);
            assertTrue("VISA luhn invalid: " + num, BlueSnapValidator.Companion.getInstance().creditCardNumberValidation(num));
            String type = creditCardTypeResolver.getType(card.getNumber());
            assertTrue("VISA type mismatch: " + type + " " + num, CreditCardTypeResolver.VISA.equals(type));
        }
    }
    ...
    public void testInValidVisa() {
        ...
        for (String num : validMC) {
            card.setNumber(num);
            assertFalse("InValidVISA luhn valid: " + num, BlueSnapValidator.Companion.getInstance().creditCardNumberValidation(num));
            String type = creditCardTypeResolver.getType(card.getNumber());
            assertTrue("InValidVISA type match: " + type + " " + num, CreditCardTypeResolver.VISA.equals(type));
        }
    }
    ...
    public void testValidMaestro() {
        ...
        for (String num : validMaestro) {
            card.setNumber(num);
            assertTrue("MAESTR_UK luhn invalid: " + num, BlueSnapValidator.Companion.getInstance().creditCardNumberValidation(num));
            String type = creditCardTypeResolver.getType(card.getNumber());
            assertTrue("MAESTR_UK type mismatch: " + type + " " + num, CreditCardTypeResolver.MASTERCARD.equals(type)); // ToDo check if server returns MC
        }
    }
    ...
    public void testValidDiscover() {
        ...
        for (String num : validDiscover) {
            card.setNumber(num);
            assertTrue("DISCOVER luhn invalid: " + num, BlueSnapValidator.Companion.getInstance().creditCardNumberValidation(num));
            String type = creditCardTypeResolver.getType(card.getNumber());
            assertTrue("DISCOVER type mismatch: " + type + " " + num, CreditCardTypeResolver.DISCOVER.equals(type));
        }
    }
    ...
    public void testInValidSolo() {
        ...
        for (String num : validSolo) {
            card.setNumber(num);
            assertTrue("SOLO luhn invalid: " + num, BlueSnapValidator.Companion.getInstance().creditCardNumberValidation(num));
            String type = creditCardTypeResolver.getType(card.getNumber());
            assertFalse("SOLO type match: " + type + " " + num, CreditCardTypeResolver.UNKNOWN.equals(type));
        }
    }
    ...
    public void testValidDiners() {
        ...
        for (String num : validDiners) {
            card.setNumber(num);
            assertTrue("DINERS luhn invalid: " + num, BlueSnapValidator.Companion.getInstance().creditCardNumberValidation(num));
            String type = creditCardTypeResolver.getType(card.getNumber());
            assertTrue("DINERS type mismatch: " + type + " " + num, CreditCardTypeResolver.DINERS.equals(type));
        }
    }
    ...
    public void testValidJCB() {
        ...
        for (String num : validJCB) {
            card.setNumber(num);
            assertTrue("JCB luhn invalid: " + num, BlueSnapValidator.Companion.getInstance().creditCardNumberValidation(num));
            String type = creditCardTypeResolver.getType(card.getNumber());
            assertTrue("JCB type mismatch: " + type + " " + num, CreditCardTypeResolver.JCB.equals(type));
        }
    }
    ...
    public void testValidCarteBleue() {
        ...
        for (String num : validCarteBleue) {
            card.setNumber(num);
            assertTrue("CARTE_BLEUE luhn invalid: " + num, BlueSnapValidator.Companion.getInstance().creditCardNumberValidation(num));
            String type = creditCardTypeResolver.getType(card.getNumber());
            assertTrue("CARTE_BLEUE type mismatch: " + type + " " + num, CreditCardTypeResolver.CARTE_BLEUE.equals(type));
        }
    }
    ...
    public void testValidChinaUnionPay() {
        ...
        for (String num : validChinaUnionPay) {
            card.setNumber(num);
            assertTrue("CHINA_UNION_PAY luhn invalid: " + num, BlueSnapValidator.Companion.getInstance().creditCardNumberValidation(num));
            String type = creditCardTypeResolver.getType(card.getNumber());
            assertTrue("CHINA_UNION_PAY type mismatch: " + type + " " + num, CreditCardTypeResolver.CHINA_UNION_PAY.equals(type));
        }
    }
    ...
    public void testInvalidStrings() {
        ...
        assertFalse(BlueSnapValidator.Companion.getInstance().creditCardNumberValidation(card.getNumber()));
        assertFalse(BlueSnapValidator.Companion.getInstance().creditCardFullValidation(card));
    }
    ...
    public void testValidateExpiryDate() {
        ...
        assertFalse("more than 12 month a year?", BlueSnapValidator.Companion.getInstance().creditCardExpiryDateValidation(card.getExpirationYear(), card.getExpirationMonth()));
        card.setExpirationMonth(21);
        card.setExpirationYear(5);
        assertFalse("Date should not be in future:" + card.getExpirationDate(),
                BlueSnapValidator.Companion.getInstance().isDateInFuture(card.getExpirationMonth(), card.getExpirationYear()));
        ...
        assertFalse("0 month is invalid", BlueSnapValidator.Companion.getInstance().creditCardExpiryDateValidation(card.getExpirationYear(), card.getExpirationMonth()));
        assertFalse(BlueSnapValidator.Companion.getInstance().creditCardFullValidation(card));

        card.setExpirationMonth(1);
        card.setExpirationYear(32);
        assertTrue("have we past the year 2032 ", BlueSnapValidator.Companion.getInstance().isDateInFuture(card.getExpirationMonth(), card.getExpirationYear()));
    ...
    public void testCurrentDateValid() {
        ...
        assertTrue("the card should be valid in the current month", BlueSnapValidator.Companion.getInstance().creditCardExpiryDateValidation(card.getExpirationYear(), card.getExpirationMonth()));

        year = now.get(Calendar.YEAR);
        month = now.get(Calendar.MONTH); //Go to last month
        card.setExpirationMonth(month);
        card.setExpirationYear(year);
        assertFalse("card should be invalid if expired last month", BlueSnapValidator.Companion.getInstance().creditCardExpiryDateValidation(card.getExpirationYear(), card.getExpirationMonth()));
        assertFalse(BlueSnapValidator.Companion.getInstance().creditCardFullValidation(card));
    ...
    public void cardToStringTest() {
        ...
        assertTrue(BlueSnapValidator.Companion.getInstance().creditCardFullValidation(creditCard));
