...
public class StateActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            // check if US, BlueSnapValidator.Companion.getInstance().STATE_NEEDED_COUNTRIES[0] = US
//            BlueSnapValidator.Companion.getInstance().getSTATE_NEEDED_COUNTRIES()
            if (countryString.equals(BlueSnapValidator.Companion.getInstance().getSTATE_NEEDED_COUNTRIES()[0])) {
            ...
            } else if (countryString.equals(BlueSnapValidator.Companion.getInstance().getSTATE_NEEDED_COUNTRIES()[1])) {
                // check if BR, BlueSnapValidator.Companion.getInstance().STATE_NEEDED_COUNTRIES[1] = BR
                ...
                // check if CA, BlueSnapValidator.Companion.getInstance().STATE_NEEDED_COUNTRIES[2] = CA
