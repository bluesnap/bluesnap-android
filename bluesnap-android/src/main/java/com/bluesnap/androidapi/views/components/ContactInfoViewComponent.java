...
public class ContactInfoViewComponent extends LinearLayout {
    ...
    void initControl(final Context context) {
        ...
        inputState.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                 BlueSnapLocalBroadcastManager.INSTANCE.sendMessage(context, BlueSnapLocalBroadcastManager.STATE_CHANGE_REQUEST,
        ...
        countryImageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                 BlueSnapLocalBroadcastManager.INSTANCE.sendMessage(context, BlueSnapLocalBroadcastManager.COUNTRY_CHANGE_REQUEST, getUserCountry(), TAG);
            }
        });
    }
    ...
    public void unregisterBlueSnapLocalBroadcastReceiver() {
        BlueSnapLocalBroadcastManager.INSTANCE.unregisterReceiver(getContext(), broadcastReceiver);
    }
    ...
    public void registerBlueSnapLocalBroadcastReceiver() {
         BlueSnapLocalBroadcastManager.INSTANCE.registerReceiver(getContext(), BlueSnapLocalBroadcastManager.STATE_CHANGE_RESPONSE, broadcastReceiver);
         BlueSnapLocalBroadcastManager.INSTANCE.registerReceiver(getContext(), BlueSnapLocalBroadcastManager.COUNTRY_CHANGE_RESPONSE, broadcastReceiver);
    }
    ...
    public boolean validateInfo() {
        ...
        if (BlueSnapValidator.Companion.getInstance().checkCountryHasState(getUserCountry()))
    ...
    public int getFirstErrorEnabledOfTextInputEditTextTopPosition() {
        ...
        else if (BlueSnapValidator.Companion.getInstance().checkCountryHasState(getUserCountry()) && inputLayoutState.isErrorEnabled())
    ...
    boolean validateField(TextInputEditText editText, TextInputLayout textInputLayout, BlueSnapValidator.EditTextFields validationType) {
        if (!BlueSnapValidator.Companion.getInstance().validateEditTextString(editText.getText().toString(), validationType)) {
    ...
    public void setUserCountry(String userCountry) {
        this.userCountry = AndroidUtil.stringify(userCountry, BlueSnapService.Companion.getInstance().getUserCountry(getContext()));
        onCountryChange();
    }
    ...
    boolean isCountryRequiresZip() {
        return (BlueSnapValidator.Companion.getInstance().checkCountryHasZip(getUserCountry()));
    }
    ...
    void changeZipHintAndTextAccordingToCountry() {
        if (!isCountryRequiresZip()) {
            ...
            inputLayoutZip.setHint(BlueSnapValidator.Companion.getInstance().getSTATE_NEEDED_COUNTRIES()[0].equals(getUserCountry())
