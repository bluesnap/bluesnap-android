...
public class ButtonComponent extends LinearLayout {
    ...
    private void initControl(Context context) {
        ...
        // Apply bottom system bar insets for Android 15+ to ensure button remains clickable
        // with both gesture and button navigation
        EdgeToEdgeUtils.applyBottomSystemBarInsets(this);
    }
    ...
    public void setBuyNowButton(ButtonComponentText buttonComponentText) {
        ...
        if (buttonComponentText.equals(ButtonComponentText.PAY)) {
            buyNowButton.setText(BlueSnapService.Companion.getInstance().getSdkRequest().getBuyNowButtonText(this));
