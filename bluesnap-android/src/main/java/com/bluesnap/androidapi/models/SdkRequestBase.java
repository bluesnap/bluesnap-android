...
public abstract class SdkRequestBase {
    ...
    boolean showSubscriptionCancellationMessage = true;
    String customSubscriptionCancellationMessage = null;
     ...
     */
    public abstract void updateTax(@Nullable String shippingCountry,@Nullable String shippingState);
    ...
    /**
     * Get whether to show the subscription cancellation message
     *
     * @return true if the message should be shown, false otherwise
     */
    public boolean isShowSubscriptionCancellationMessage() {
        return showSubscriptionCancellationMessage;
    }

    /**
     * Set whether to show the subscription cancellation message
     *
     * @param showSubscriptionCancellationMessage true to show the message, false to hide it
     */
    public void setShowSubscriptionCancellationMessage(boolean showSubscriptionCancellationMessage) {
        this.showSubscriptionCancellationMessage = showSubscriptionCancellationMessage;
    }

    /**
     * Get the custom subscription cancellation message
     *
     * @return the custom message, or null if using the default message
     */
    public String getCustomSubscriptionCancellationMessage() {
        return customSubscriptionCancellationMessage;
    }

    /**
     * Set a custom subscription cancellation message
     *
     * @param customSubscriptionCancellationMessage the custom message to display, or null to use the default
     */
    public void setCustomSubscriptionCancellationMessage(String customSubscriptionCancellationMessage) {
