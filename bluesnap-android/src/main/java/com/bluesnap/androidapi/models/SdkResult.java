...
public class SdkResult implements Parcelable {
    ...
    // New fields for ACH/ECP transactions
    ...
    protected SdkResult(Parcel in) {
        ...
        // Read new ACH/ECP fields
        setPaymentMethod(in.readString());
        setRoutingNumber(in.readString());
