...
public class HTTPOperationController {
    ...
    public static BlueSnapHTTPResponse put(String urlString, String body, String contentType, String accept, List<CustomHTTPParams> httpParams) {
        ...
        try {
            ...
            String curlCommand = generateCurlCommand(connection, body);
    ...
    private static String generateCurlCommand(HttpURLConnection connection, String body) {
        StringBuilder curlCmd = new StringBuilder("curl");

        // Add method
        curlCmd.append(" -X ").append(connection.getRequestMethod());
        ...
        for (Map.Entry<String, List<String>> entry : headers.entrySet()) {
            ...
            for (String value : entry.getValue()) {
                curlCmd.append(" -H \"").append(headerName).append(": ").append(value).append("\"");
            }
        }
        ...
        if (body != null && !body.isEmpty()) {
            ...
            curlCmd.append(" --data '").append(escapedBody).append("'");
        }

        // Add URL
        curlCmd.append(" \"").append(connection.getURL().toString()).append("\"");
